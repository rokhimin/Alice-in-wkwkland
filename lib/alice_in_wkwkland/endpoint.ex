defmodule AliceInWkwkland.Endpoint do
  use Plug.Router
  use Plug.Debugger
  use Plug.ErrorHandler

  alias AliceInWkwkland.Router
  ...
  forward("/api/AliceInWkwkland", to: Router)
  ...
  defp config, do: Application.fetch_env(:alice_in_wkwkland, __MODULE__)
  defp redirect_url, do: Application.get_env(:alice_in_wkwkland, :redirect_url)
